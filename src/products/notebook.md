...
layout: base.njk
title: Notebook
permalink: /products/notebook/
seoTitle: Hand-Bound Leather Notebook | Ardent Leatherworks
description: Wickett & Craig harness leather, Midori MD Cotton paper, woven long stitch binding, hand-sewn endbands, burnished edges. A5, 100 pages. $50, shipping included.
---
...
<p class="product-price-large">$50</p>
<p class="product-shipping">Shipping included · Tax at checkout · Ships within one week</p>

</div>

<p class="product-intro">Wickett & Craig harness. Midori MD Cotton. Woven long stitch. Hand-sewn endbands.</p>

<div class="product-images">
  <p class="image-placeholder">Images forthcoming:</p>
  <ul class="image-placeholder-list">
    <li>Closed notebook, front</li>
    <li>Open flat, showing binding</li>
    <li>Spine detail (woven stitch + endbands)</li>
    <li>Paper texture close-up</li>
    <li>Edge burnish detail</li>
  </ul>
</div>
...
Workmanship guaranteed. If the binding fails, we repair it.
